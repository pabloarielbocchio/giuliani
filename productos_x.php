...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/productos_x.controller.php";
            ...
            <div class="modal-dialog" productoe="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">Producto Standar:</label>
...
<script type="text/javascript" src="inc/js/productos_x_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
