...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/eventos.controller.php";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" eventoe="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-evento" name="btn-eliminar-evento" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosEvento">
        <div class="modal fade" id="dataRegister" tabindex="-1" eventoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" eventoe="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosEvento">
        <div class="modal fade" id="dataUpdate" tabindex="-1" eventoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" eventoe="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
