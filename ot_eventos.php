...
$_SESSION['menu'] = "ot_eventos.php";

$_SESSION['breadcrumb'] = "Ot_eventos";

$titlepage = "Ot_eventos";
...
<div class="container">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-ot_evento" name="btn-eliminar-ot_evento" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> 
                            ...
                            <select id="detalleAdd" style="width: 100%;" class="form-control" name="detalleAdd"  required>
                                <?php 
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">#OT Detalle:</label>
                            <select id="eventoAdd" style="width: 100%;" class="form-control" name="eventoAdd"  required>
                                <?php 
    ...
    <form id="actualidarDatosOt_evento">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">#OT Detalle:</label>
                            <select id="detalleUpdate" style="width: 100%;" class="form-control" name="detalleUpdate"  required>
                                <?php 
                                    foreach ($ots_detalles as $aux) { 
                                ?>
                                        <option value="<?php echo $aux["codigo"]; ?>" ><?php echo $aux["descripcion"]; ?></option>
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">#OT Detalle:</label>
                            <select id="eventoUpdate" style="width: 100%;" class="form-control" name="eventoUpdate"  required>
                                <?php 
                                    foreach ($eventos as $aux) { 
                                ?>
                                        <option value="<?php echo $aux["codigo"]; ?>" ><?php echo $aux["descripcion"]; ?></option>
...
<script type="text/javascript" src="inc/js/ot_eventos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
