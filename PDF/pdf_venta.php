...
$pdf = new TCPDF("L", "mm", array('80','240'), true, 'UTF-8', false);
...
for ($i = 0; $i < 1; $i++){
    ...
    <td>
        <table> 
            <thead>
                <tr>
                    ...
                    <td width="150" align="left" style="font-size: 9px;">
                        <br />
        ...
        '<table> 
            <!-- <thead>
                <tr bgcolor="#EEEEEE">
                    <th width="30" style="font-size: 9px;" align="right">Cant.</th>
                    <th width="210" style="font-size: 9px;" align="left">Producto</th>
                </tr>
            </thead> -->
            <tbody>';
            $html .= '<tr>';
        ...
        foreach ($detalles as $reg) {  
            if ($last_rubro != $reg["rubro_desc"]){
                if ($last_rubro){
                    $html .= '<tr>';
                    $html .= '<td width="100" align="left" valign="middle"><b></b></td>';
                    $html .= '<td width="40" align="right" valign="middle"><b></b></td>';
                    $html .= '<td width="50" align="right" valign="middle"><b></b></td>';
                    $html .= '<td width="50" align="right" valign="middle"><b></b></td>';
                    $html .= '</tr>';
                }
                $html .= '<tr>';
                $html .= '<td width="130" style="font-size: 9px;" align="left" valign="middle"><u><b>' . $reg["rubro_desc"] . '</b></u></td>';
                $html .= '<td width="30" style="font-size: 9px;" align="right" valign="middle"></td>';
                $html .= '<td width="40" style="font-size: 9px;" align="right" valign="middle"></td>';
                $html .= '<td width="40" style="font-size: 9px;" align="right" valign="middle"></td>';
                $html .= '</tr>';
            }
            $last_rubro = $reg["rubro_desc"];
            $total += $reg["precio"] * $reg["cantidad"];
            $html .= '<tr>';
            $html .= '<td width="30" style="font-size: 9px;" align="right" valign="middle"><b>' . number_format($reg["cantidad"],0) . '</b></td>';
            $html .= '<td width="210" style="font-size: 9px;" align="left" valign="middle"><b>' . $reg["producto"] . '</b></td>';
            $html .= '</tr>';
        }
        ...
        $html .= '<tr>';
        $html .= '<td width="10" align="left" valign="middle"><b></b></td>';
        $html .= '<td width="30" align="right" valign="middle"><b></b></td>';
        $html .= '<td width="100" style="font-size: 9px;"  align="right" valign="middle"><b><u>Subtotal</u></b></td>';
        $html .= '<td width="100" style="font-size: 9px;"  align="right" valign="middle"><b><i>$ ' . number_format($total,2) . '</i></b></td>';
        $html .= '</tr>';
                
        $html .= '<tr>';
        $html .= '<td width="10" align="left" valign="middle"><b></b></td>';
        $html .= '<td width="30" align="right" valign="middle"><b></b></td>';
        $html .= '<td width="100" style="font-size: 9px;"  align="right" valign="middle"><b><u>Descuento</u></b></td>';
        $html .= '<td width="100" style="font-size: 9px;"  align="right" valign="middle"><b><i>$ ' . number_format($pedido["descuento"],2) . '</i></b></td>';
        $html .= '</tr>';
                
        $html .= '<tr>';
        $html .= '<td width="10" align="left" valign="middle"><b></b></td>';
        $html .= '<td width="30" align="right" valign="middle"><b></b></td>';
        $html .= '<td width="100" style="font-size: 9px;"  align="right" valign="middle"><b><u>Envío</u></b></td>';
        $html .= '<td width="100" style="font-size: 9px;"  align="right" valign="middle"><b><i>$ ' . number_format($pedido["costo_envio"],2) . '</i></b></td>';
        $html .= '</tr>';
        
        $html .= '<tr>';
        $html .= '<td width="240" align="left" valign="middle"><b></b></td>';
        $html .= '</tr>';
        ...
        $html .= '<td width="10" align="left" valign="middle"><b></b></td>';
        $html .= '<td width="30" align="right" valign="middle"><b></b></td>';
        $html .= '<td width="100" style="font-size: 9px;"  align="right" valign="middle"><b><u>TOTAL</u></b></td>';
        $html .= '<td width="100" style="font-size: 9px;"  align="right" valign="middle"><b><i>$ ' . number_format($total - $pedido["descuento"] + $pedido["costo_envio"],2) . '</i></b></td>';
        $html .= '</tr>';
        ...
        if ($pedido["comentarios"]) {
            $html .= '<tr>';
            $html .= '<td width="240" style="font-size: 9px;"  align="left" valign="middle"><b>Comentarios: </b> '. $pedido["comentarios"] . '</td>';
            $html .= '</tr>';
        }
