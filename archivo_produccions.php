...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/archivo_produccions.controller.php";
$controlador = Archivo_produccionsController::singleton_archivo_produccions();
$archivos = $controlador->getArchivos();
$produccions = $controlador->getProduccions();

$_SESSION["totales"] = $controlador->getCountArchivo_produccions();
...
$_SESSION['menu'] = "archivo_produccions.php";

$_SESSION['breadcrumb'] = "Archivo_produccions";

$titlepage = "Archivo_produccions";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" archivo_produccionse="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-archivo_produccions" name="btn-eliminar-archivo_produccions" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosArchivo_produccions">
        <div class="modal fade" id="dataRegister" tabindex="-1" archivo_produccionse="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" archivo_produccionse="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">Archivo:</label>
                            <select id="archivoAdd" style="width: 100%;" class="form-control" name="archivoAdd"  required>
                                <?php 
    ...
    <form id="actualidarDatosArchivo_produccions">
        <div class="modal fade" id="dataUpdate" tabindex="-1" archivo_produccionse="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" archivo_produccionse="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">Archivo:</label>
                            <select id="archivoUpdate" style="width: 100%;" class="form-control" name="archivoUpdate"  required>
                                <?php 
                                    foreach ($archivos as $aux) { 
                                ?>
                                        <option value="<?php echo $aux["codigo"]; ?>" ><?php echo $aux["descripcion"]; ?></option>
...
<script type="text/javascript" src="inc/js/archivo_produccions_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
