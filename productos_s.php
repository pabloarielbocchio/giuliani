...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/productos_s.controller.php";
...
<script type="text/javascript" src="inc/js/productos_s_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
