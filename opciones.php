...
>
    ...
    <div class="modal fade" id="myModal" productoe="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-producto" name="btn-eliminar-producto" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosProducto">
        <div class="modal fade" id="dataRegister" tabindex="-1" productoe="dialog" aria-labelledby="exampleModalLabel">
    ...
    <form id="actualidarDatosProducto">
        <div class="modal fade" id="dataUpdate" tabindex="-1" productoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" productoe="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="modal fade" id="myModalAlt" productoe="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 id="name-header-modalAlt" class="modal-title">Eliminar</h4>
                </div>
                <div class="modal-body text-center"  id="text-header-bodyAlt">

                </div>
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-productoAlt" name="btn-eliminar-productoAlt" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
                    <button type="button" id="btn-cancelar" name="btn-cancelar" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                </div>
            </div>
        </div>
    ...
    <form id="guardarDatosProductoAlt">
        <div class="modal fade" id="dataRegisterAlt" tabindex="-1" productoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" productoe="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Nombre:</label>
                            <input type="text" class="form-control" id="descripcionAddAlt" name="descripcionAddAlt" required maxlength="100">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-danger boton_marron_carni" >Guardar datos</button>
    ...
    <form id="actualidarDatosProductoAlt">
        <div class="modal fade" id="dataUpdateAlt" tabindex="-1" productoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" productoe="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Nombre:</label>
                            <input type="text" class="form-control" id="descripcionUpdateAlt" name="descripcionUpdateAlt" required maxlength="100">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-danger boton_marron_carni" >Actualizar datos</button>
...
<script type="text/javascript" src="inc/js/opciones_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
