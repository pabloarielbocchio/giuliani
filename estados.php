...
$_SESSION["totales"] = $controlador->getCountEstados();
...
$_SESSION['menu'] = "estados.php";

$_SESSION['breadcrumb'] = "Estados";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" estadoe="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-estado" name="btn-eliminar-estado" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosEstado">
        <div class="modal fade" id="dataRegister" tabindex="-1" estadoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" estadoe="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosEstado">
        <div class="modal fade" id="dataUpdate" tabindex="-1" estadoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" estadoe="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/estados_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
