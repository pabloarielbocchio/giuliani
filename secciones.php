...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/secciones.controller.php";
$controlador = SeccionesController::singleton_secciones();

$_SESSION["totales"] = $controlador->getCountSecciones();
...
$_SESSION['menu'] = "secciones.php";

$_SESSION['breadcrumb'] = "Secciones";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" seccione="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-seccion" name="btn-eliminar-seccion" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosSeccion">
        <div class="modal fade" id="dataRegister" tabindex="-1" seccione="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" seccione="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosSeccion">
        <div class="modal fade" id="dataUpdate" tabindex="-1" seccione="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" seccione="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/secciones_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
