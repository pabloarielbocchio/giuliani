        ...
        if (!$respuesta) {
            ...
            if (!$move_upload) {
                ...
                if ($existia_antes == 0) {
                    ...
                    $controlador->addArchivo($fileName, $uploadPath . $fileName, $fecha_hora, $activo, null, null, null, null, null, null, null, null, $otp);
                    $ultimo = $controlador->getLastArchivo()[0]["codigo"];
                    $controlador->addArchivo_produccion($ultimo, null, "", $otp);
