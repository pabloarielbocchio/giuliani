...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/tipos.controller.php";
$controlador = TiposController::singleton_tipos();

$_SESSION["totales"] = $controlador->getCountTipos();
...
$_SESSION['menu'] = "tipos.php";

$_SESSION['breadcrumb'] = "Tipos";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" tipoe="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-tipo" name="btn-eliminar-tipo" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosTipo">
        <div class="modal fade" id="dataRegister" tabindex="-1" tipoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" tipoe="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosTipo">
        <div class="modal fade" id="dataUpdate" tabindex="-1" tipoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" tipoe="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/tipos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
