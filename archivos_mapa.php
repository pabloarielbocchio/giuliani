...
$_SESSION['menu'] = "archivos_mapa.php";

$_SESSION['breadcrumb'] = "Mapa de Desarrollo";
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 id="name-header-modal" class="modal-title">Lista de Archivos</h4>
                </div>
                <div class="modal-body text-center"  id="text-header-body">

                </div>
                <div class="modal-footer">
                   <button type="button" id="btn-cancelar" name="btn-cancelar" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="inc/js/archivos_mapa_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
