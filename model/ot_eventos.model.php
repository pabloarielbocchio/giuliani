    ...
    public function getRegistrosFiltro($orderby, $sentido, $registros, $pagina, $busqueda){
        try {
            ...
            $sql = "SELECT 
                        ...
                        (select nro_serie from orden_trabajos s where s.codigo = otdet.orden_trabajo_id) as nro_serie,
                    ...
                    left join orden_trabajos_detalles otdet on otp.ot_detalle_id = otdet.codigo                
