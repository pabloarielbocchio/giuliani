...
class ProductosController {
    ...
    public function __construct() {
        try {
            include $_SERVER['DOCUMENT_ROOT']."/Giuliani/model/productos_a.model.php";
    ...
    public function getRegistrosFiltro($orderby, $sentido, $registros, $pagina, $busqueda){
        ...
        include $_SERVER['DOCUMENT_ROOT']."/Giuliani/templates/productos_a.busqueda.template.php";
        
    }
    
    public function addProducto($descripcion) {
        $devuelve = $this->conn->addProducto($descripcion);
        
        return $devuelve;
        
    }
    
    public function updateProducto($codigo, $descripcion) {
        $devuelve = $this->conn->updateProducto($codigo, $descripcion);
