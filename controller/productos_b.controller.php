...
class ProductosController {
    ...
    public function __construct() {
        try {
            include $_SERVER['DOCUMENT_ROOT']."/Giuliani/model/productos_b.model.php";
    ...
    public function getRegistrosFiltro($orderby, $sentido, $registros, $pagina, $busqueda){
        ...
        include $_SERVER['DOCUMENT_ROOT']."/Giuliani/templates/productos_b.busqueda.template.php";
        
    }
    
    public function addProducto($descripcion, $proda) {
        $devuelve = $this->conn->addProducto($descripcion, $proda);
    ...
    public function updateProducto($codigo, $descripcion, $proda) {
        $devuelve = $this->conn->updateProducto($codigo, $descripcion, $proda);
