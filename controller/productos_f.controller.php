...
class ProductosController {
    ...
    public function __construct() {
        try {
            include $_SERVER['DOCUMENT_ROOT']."/Giuliani/model/productos_f.model.php";
    ...
    public function getRegistrosFiltro($orderby, $sentido, $registros, $pagina, $busqueda){
        ...
        include $_SERVER['DOCUMENT_ROOT']."/Giuliani/templates/productos_f.busqueda.template.php";
        
    }
    
    public function addProducto($descripcion, $prode) {
        $devuelve = $this->conn->addProducto($descripcion, $prode);
    ...
    public function updateProducto($codigo, $descripcion, $prode) {
        $devuelve = $this->conn->updateProducto($codigo, $descripcion, $prode);
