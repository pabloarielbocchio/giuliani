...
class ProductosController {
    ...
    public function __construct() {
        try {
            include $_SERVER['DOCUMENT_ROOT']."/Giuliani/model/productos_c.model.php";
    ...
    public function getRegistrosFiltro($orderby, $sentido, $registros, $pagina, $busqueda){
        ...
        include $_SERVER['DOCUMENT_ROOT']."/Giuliani/templates/productos_c.busqueda.template.php";
        
    }
    
    public function addProducto($descripcion, $prodb) {
        $devuelve = $this->conn->addProducto($descripcion, $prodb);
        
        return $devuelve;
        
    }
    
    public function updateProducto($codigo, $descripcion, $prodb) {
        $devuelve = $this->conn->updateProducto($codigo, $descripcion, $prodb);
