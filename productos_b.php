...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/productos_b.controller.php";
...
<script type="text/javascript" src="inc/js/productos_b_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
