...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/destinos.controller.php";
$controlador = DestinosController::singleton_destinos();

$_SESSION["totales"] = $controlador->getCountDestinos();
...
$_SESSION['menu'] = "destinos.php";

$_SESSION['breadcrumb'] = "Destinos";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" destinoe="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-destino" name="btn-eliminar-destino" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosDestino">
        <div class="modal fade" id="dataRegister" tabindex="-1" destinoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" destinoe="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosDestino">
        <div class="modal fade" id="dataUpdate" tabindex="-1" destinoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" destinoe="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/destinos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
