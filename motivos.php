...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/motivos.controller.php";
$controlador = MotivosController::singleton_motivos();

$_SESSION["totales"] = $controlador->getCountMotivos();
...
$_SESSION['menu'] = "motivos.php";

$_SESSION['breadcrumb'] = "Motivos";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" motivoe="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-motivo" name="btn-eliminar-motivo" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosMotivo">
        <div class="modal fade" id="dataRegister" tabindex="-1" motivoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" motivoe="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosMotivo">
        <div class="modal fade" id="dataUpdate" tabindex="-1" motivoe="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" motivoe="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/motivos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
