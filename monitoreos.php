...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/monitoreos.controller.php";
$controlador    = MonitoreosController::singleton_monitoreos();
$monitoreoes         = $controlador->getMonitoreosAll();
$roles          = $controlador->getRoles();
$niveles        = array();
$subniveles     = array();
$opciones       = array();
foreach ($monitoreoes as $m){
    $nivel = 1;
    if ($m["nivel"] > 0){
        $niveles[] = $m;
        $nivel++;
...
$_SESSION["totales"] = $controlador->getCountMonitoreos();
...
$_SESSION['breadcrumb'] = "Monitoreos";

$titlepage = "Giuliani - Monitoreos";
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-monitoreo" name="btn-eliminar-monitoreo" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">Nuevo Monitoreo</h4>
                    </div>
        ...
        <div class="modal fade" id="dataUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="exampleModalLabel">Modificar Monitoreo</h4>
                    </div>
                    <div class="modal-body">
                        <div id="datos_ajax_register"></div>
...
<?php if ($_SESSION["permisos"][$_SESSION['monitoreo']]["new"]) { ?>
...
<script type="text/javascript" src="inc/js/monitoreos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
