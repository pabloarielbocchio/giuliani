...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/ot_produccions.controller.php";
$controlador = Ot_produccionsController::singleton_ot_produccions();
$ots_detalles = $controlador->getOtsDetalles();
$standards = $controlador->getStandards();
$personalizados = $controlador->getPersonalizados();
$unidades = $controlador->getUnidades();
$estados = $controlador->getEstados();
$prioridades = $controlador->getPrioridades();

$_SESSION["totales"] = $controlador->getCountOt_produccions();
...
$_SESSION['menu'] = "ot_produccions.php";

$_SESSION['breadcrumb'] = "Ot_produccions";

$titlepage = "Ot_produccions";
...
<div class="container">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-ot_produccion" name="btn-eliminar-ot_produccion" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosOt_produccion">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="avanceAdd" name="avanceAdd" required maxlength="100">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">Standard:</label>
                            <select id="opcionAdd" style="width: 100%;" class="form-control" name="opcionAdd"  required>
                        ...
                        <div class="form-group"> 
                            ...
                            <select id="standarAdd" style="width: 100%;" class="form-control" name="standarAdd"  required>
                                <?php 
                                    foreach ($standards as $aux) { 
                                ?>
                        ...
                        <div class="form-group"> 
                            ...
                            <select id="personalizadoAdd" style="width: 100%;" class="form-control" name="personalizadoAdd"  required>
                                <?php 
                                    foreach ($personalizados as $aux) { 
                                ?>
                                        <option value="<?php echo $aux["codigo"]; ?>" ><?php echo $aux["descripcion"]; ?></option>
                                <?php 
                                    }
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">Standard:</label>
                            <select id="opcionUpdate" style="width: 100%;" class="form-control" name="opcionUpdate"  required>
                                <option value="0" >Personalizado</option>
                                <option value="1" >Standard</option>
                            </select>
                        </div>
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">Producto Standard:</label>
                            <select id="standarUpdate" style="width: 100%;" class="form-control" name="standarUpdate"  required>
                                <?php 
                                    foreach ($standards as $aux) { 
                                ?>
                                        <option value="<?php echo $aux["codigo"]; ?>" ><?php echo $aux["descripcion"]; ?></option>
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">Producto Personalizado:</label>
                            <select id="personalizadoUpdate" style="width: 100%;" class="form-control" name="personalizadoUpdate"  required>
                                <?php 
                                    foreach ($personalizados as $aux) { 
                                ?>
                                        <option value="<?php echo $aux["codigo"]; ?>" ><?php echo $aux["descripcion"]; ?></option>
                        ...
                        <div class="form-group"> 
                            <label for="nombre0" class="control-label">Unidad:</label>
                            <select id="unidadUpdate" style="width: 100%;" class="form-control" name="unidadUpdate"  required>
                                <?php 
                                    foreach ($unidades as $aux) { 
                                ?>
                                        <option value="<?php echo $aux["codigo"]; ?>" ><?php echo $aux["descripcion"]; ?></option>
...
<script type="text/javascript" src="inc/js/ot_produccions_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
