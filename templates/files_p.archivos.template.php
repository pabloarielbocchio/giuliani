                            ...
                            <li style="list-style: none">
                                <div class="ibox-galeria">
                                    <div class="ibox-content galeria-box">
                                            ...
                                            <small class="text-muted">
                                                <?php 
                                                    if (strlen($archivo["nombre"]) > 12) {
                                                        echo substr($archivo["nombre"],0,10) . "..."; 
                                                    } else {
                                                        echo $archivo["nombre"];
                                                    }
                                                ?>
                                        ...
                                        <div class="galeria-imitation download" descarga="<?php echo $archivo["ruta"]; ?>" nombre="<?php echo $archivo["nombre"]; ?>" style="text-align: center; cursor: pointer;">
