<table id="tabla" namefile="Ot_listados" totales="<?php echo $_SESSION["totales"]; ?>" registros="<?php echo $_SESSION['cant_reg']; ?>" pagina="<?php $_SESSION['pagina']; ?>" class="table table-striped table-hover" mes="<?php echo $mes; ?>" anio="<?php echo $anio; ?>" dia="<?php echo $dia; ?>" opcion="<?php echo $opcion; ?>"> 
    <thead>
        <tr class="row " style="background-color: transparent;">
            ...
            <th class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center ordena" orderby="cliente" sentido="asc">Cliente</th>
            <th class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center ordena" orderby="observaciones" sentido="asc">Nombre OT</th>
    ...
    <tbody id="body">
        <?php foreach ($registros as $usu) { ?>
            <tr class="row single_registro" codigo="<?php echo $usu["codigo"]; ?>">
                ...
                <td class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-left" style="vertical-align: middle;"><?php echo $usu["cliente"]; ?></td>
                <td class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-left" style="vertical-align: middle;"><?php echo $usu["observaciones"]; ?></td>
