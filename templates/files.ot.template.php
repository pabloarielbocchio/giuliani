...
<div class="row" >
    ...
    <fieldset>
        ...
        <div class="row" style="margin-top: 10px; <?php if ($readonly == 1) { echo 'display: none; '; } ?>">
            <div class="col-md-12">
                <form action="subir_ot.php" class="dropzone" id="formdropZone">
...
<script>
    ...
    var myDropzone = new Dropzone("#formdropZone", { url: "subir_ot.php"});        
