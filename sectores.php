...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/sectores.controller.php";
$controlador = SectoresController::singleton_sectores();

$_SESSION["totales"] = $controlador->getCountSectores();
...
$_SESSION['menu'] = "sectores.php";

$_SESSION['breadcrumb'] = "Sectores";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" sectore="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-sector" name="btn-eliminar-sector" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosSector">
        <div class="modal fade" id="dataRegister" tabindex="-1" sectore="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" sectore="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosSector">
        <div class="modal fade" id="dataUpdate" tabindex="-1" sectore="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" sectore="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/sectores_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
