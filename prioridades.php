...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/prioridades.controller.php";
$controlador = PrioridadesController::singleton_prioridades();

$_SESSION["totales"] = $controlador->getCountPrioridades();
...
$_SESSION['menu'] = "prioridades.php";

$_SESSION['breadcrumb'] = "Prioridades";

$titlepage = "Prioridades";
...
<div class="container">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-prioridad" name="btn-eliminar-prioridad" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="prioridadAdd" name="prioridadAdd" required maxlength="5">
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <form id="actualidarDatosPrioridad">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Prioridad:</label>
                            <input type="number" class="form-control" id="prioridadUpdate" name="prioridadUpdate" required maxlength="5">
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script type="text/javascript" src="inc/js/prioridades_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
