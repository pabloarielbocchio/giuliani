...
include $_SERVER['DOCUMENT_ROOT'] . "/Giuliani/controller/archivo_destinos.controller.php";
...
$_SESSION["totales"] = $controlador->getCountArchivo_destinos();
...
$_SESSION['menu'] = "archivo_destinos.php";

$_SESSION['breadcrumb'] = "Archivo_destinos";

$titlepage = "Archivo_destinos";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" archivo_destinose="dialog"> 
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-archivo_destinos" name="btn-eliminar-archivo_destinos" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
    ...
    <form id="guardarDatosArchivo_destinos">
        <div class="modal fade" id="dataRegister" tabindex="-1" archivo_destinose="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" archivo_destinose="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosArchivo_destinos">
        <div class="modal fade" id="dataUpdate" tabindex="-1" archivo_destinose="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" archivo_destinose="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/archivo_destinos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
