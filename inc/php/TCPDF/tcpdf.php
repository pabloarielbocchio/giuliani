	...
	public function Footer() {
		...
		if ($this->getRTL()) {
			...
			$this->Cell(0, 0, $this->getAliasRightShift().$pagenumtxt, 'T', 0, 'R');
                ...
                $this->Image('../imagenes/pie_ticket.png', 5, 135, 95, 8, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false);
                $this->Image('../imagenes/pie_ticket.png', 95, 135, 105, 8, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false);
	}
