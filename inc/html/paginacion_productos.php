...
<div id="div_paginacion" class="row" style="border-bottom: 1px  #DFDFDFDF solid; margin-top: -10px; margin-bottom: 10px; padding-bottom: px; font-size: 11px;" orderby="<?php $_SESSION["orderby"]; ?>" sentido="<?php $_SESSION["sentido"]; ?>">
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="float: left;text-align: left;margin-top: 5px; ">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="float: left;text-align: left;margin-top: 0px; display: none;">
