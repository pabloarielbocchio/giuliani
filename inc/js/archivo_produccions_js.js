...
$('#dataUpdate').on('shown.bs.modal', function () {
    $('#archivo_produccionUpdate').focus();
});
...
$("#actualidarDatosArchivo_produccions").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updateArchivo_produccion",
            codigo: codigo,
            observaciones: $("#observacionesUpdate").val(),
            archivo: $("#archivoUpdate").val(),
...
$("#guardarDatosArchivo_produccions").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "addArchivo_produccion",
            observaciones: $("#observacionesAdd").val(),
            archivo: $("#archivoAdd").val(),
