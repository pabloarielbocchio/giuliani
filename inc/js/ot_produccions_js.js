...
$("#actualidarDatosOt_produccion").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updateOt_produccion",
            codigo: codigo,
            avance: $("#avanceUpdate").val(),
            cantidad: $("#cantidadUpdate").val(),
            standard: $("#opcionUpdate").val(),
            prod_id: $("#standarUpdate").val(),
            personalizado_id: $("#personalizadoUpdate").val(),
            unidad: $("#unidadUpdate").val(),
            estado: $("#estadoUpdate").val(),
            prioridad: $("#prioridadUpdate").val(),
            detalle: $("#otUpdate").val(),
...
$("#guardarDatosOt_produccion").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            ...
            standard: $("#opcionAdd").val(),
            prod_id: $("#standarAdd").val(),
            personalizado_id: $("#personalizadoAdd").val(),
