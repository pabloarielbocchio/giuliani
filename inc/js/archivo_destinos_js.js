...
$("#actualidarDatosArchivo_destinos").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updateArchivo_destino",
            codigo: codigo,
...
$("#guardarDatosArchivo_destinos").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
