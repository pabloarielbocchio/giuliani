...
function getRegistros(orderby, sentido, registros, pagina, busqueda, objeto) {
    if (!requestSent) {
        ...
        $.ajax({
            type: "POST",
            url: 'controller/ot_busquedas.controller.php',
            data: parametros,
...
$("#actualidarDatosOt_busqueda").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updateOt_busqueda",
            codigo: codigo,
            item: $("#itemUpdate").val(),
...
$("#guardarDatosOt_busqueda").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "addOt_busqueda",
            item: $("#itemAdd").val(),
