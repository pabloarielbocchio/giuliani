...
$("#actualidarDatosUsuario_destino").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updateUsuario_destino",
            codigo: codigo,
...
$("#guardarDatosUsuario_destino").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var sucursales = $("#sucursalAdd").val();
        var parametros = {
            funcion: "addUsuario_destino",
