...
$("#actualidarDatosOt_estado").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updateOt_estado",
            codigo: codigo,
...
$("#guardarDatosOt_estado").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "addOt_estado",
